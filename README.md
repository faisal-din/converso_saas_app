<div align="center">
  ...
  <h3 align="center">Converso - LMS with Next.js, Supabase & Payments</h3>

[🌐 Live Demo](https://converso-coral-ten.vercel.app/)
...
Converso an LMS SaaS app featuring user authentication, subscriptions, and payments using Next.js, Supabase, and Clerk Payments! You'll build and deploy a real-time teaching platform with Vapi, integrate an AI vocal agent, and deliver seamless, interactive learning sessions.
...
```bash
git clone https://github.com/faisal-din/converso_saas_app
cd converso_saas_app
```
...
Replace the placeholder values with your actual , Supabase, Clerk, Vapi and Sentry credentials.
